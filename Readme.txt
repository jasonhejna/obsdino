...
1. To load the tables into your database Open "users.sql", and "happy.sql" with MySQL (UTF-8).
2. Adjust connection settings in dbc.php
3. In your web browser, navigate to the folder on your localhost.
4. Horay, the site works! Now register a new account, and start derping around.
5. Give me feedback, jasonhejna.com
